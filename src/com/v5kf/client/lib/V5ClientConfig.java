...
//	private long nonce;//[修改]去掉nonce
	...
	/* 图片服务 */
	private String wxyturl;
	private String wxytauth;
...
//	}
	...
	public String getWxyturl() {
		return wxyturl;
	}

	protected void setWxyturl(String wxyturl) {
		this.wxyturl = wxyturl;
	}

	protected void setWxytauth(String authorization2) {
		this.wxytauth = authorization2;
	}
	
	public String getWxytauth() {
		return wxytauth;
	}
...
//			}
	...
	public String getV5VisitorId() {
		...
		if (uid == null || uid.isEmpty()) {
			try {
				v5VisitorId = V5Util.md5(V5Util.getRandomString(16) + getSiteAccount() + getSiteId());
			} catch (NoSuchAlgorithmException e) {
				e.printStackTrace();
			}
		} else {
			try {
				v5VisitorId = V5Util.md5(uid + getSiteAccount() + getSiteId());
			} catch (NoSuchAlgorithmException e) {
				e.printStackTrace();
			}
		}
