...
//	}
	 ...
	 */
	public static V5Message receiveMessage(JSONObject jsonMsg) throws JSONException {
	 ...
	 * @return
	 */
	public static V5TextMessage obtainTextMessage(String content) {
	 ...
	 * @return
	 */
	public static V5LocationMessage obtainLocationMessage(double x, double y, double scale, String label) {
	 ...
	 * @return
	 */
	public static V5ControlMessage obtainControlMessage(int code, int argc, String argv) {
	 ...
	 * @return
	 */
	public static V5ImageMessage obtainImageMessage(String pic_url, String media_id) {
	 ...
	 * @return
	 */
	public static V5ImageMessage obtainImageMessage(String filePath) {
	...
	public static V5JSONMessage obtainJSONMessage(JSONObject json) {
