...
import com.v5kf.mcss.ui.activity.UserLoginActivity;
...
public class SettingMoreActivity extends BaseActivity implements OnClickListener, OnSwitchChangedListener {
				...
				new WarningDialogListener() {				
					...
					public void onClick(View view) {
						...
						case R.id.btn_dialog_warning_right:	
							try {
								LoginRequest lr = (LoginRequest) RequestManager.getRequest(QAODefine.O_TYPE_WLOGIN, SettingMoreActivity.this);
								lr.logout(mAppInfo.getUser().getE_id(), mAppInfo.getUser().getW_id());
							} catch (JSONException e) {
								e.printStackTrace();
							}
							dismissWarningDialog();
							MobclickAgent.onEvent(SettingMoreActivity.this,"APP_LOGOUT");
