...
public class UserLoginActivity extends BaseLoginActivity implements NetworkListener {
...
//			showWarningDialog(R.string.on_other_dev_login_err, null);
	...
	private void findView() {
		mForgetTv = (TextView) findViewById(R.id.forget_pwd);
	...
	private void initView() {
		...
		if (mWsp.readWorkerPhoto() != null) {
			ImageLoader imageLoader = new ImageLoader(this, true, R.drawable.v5_photo_default, null);
			imageLoader.DisplayImage(mWsp.readWorkerPhoto(), mWorkerPhoto);
		}
		
		mForgetTv.setOnClickListener(new OnClickListener() {			
			@Override
