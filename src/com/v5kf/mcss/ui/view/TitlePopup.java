...
public class TitlePopup extends PopupWindow {
	...
	//列表弹窗的间隔
	protected final int LIST_PADDING = DevUtils.dp2px(10);
	protected final int REC_PADDING = 40;
	...
	public TitlePopup(Context context, int width, int height){
		...
		//获得屏幕的宽度和高度
		mScreenWidth = DevUtils.getScreenWidth(mContext);
...
//		Logger.d("TitlePopup", "PopWindow:" + getWidth() + " viewWidth:" + view.getWidth() + " mLocation[0]:" + mLocation[0] + " mLocation[1]:" + mLocation[1]);
		showAtLocation(view, popupGravity, mLocation[0] + view.getWidth() / 2 - DevUtils.dp2px(136) + REC_PADDING, mRect.bottom);
		...
		mListView.setAdapter(new BaseAdapter() {			
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if(convertView == null){
					...
					//设置文本域的范围
					int padding_v = DevUtils.dp2px(mContext, 6);
					int padding_h = DevUtils.dp2px(mContext, 4);
				...
				//设置文字与图标的间隔
				textView.setCompoundDrawablePadding(DevUtils.dp2px(6));
				//设置在文字的左边放一个图标
