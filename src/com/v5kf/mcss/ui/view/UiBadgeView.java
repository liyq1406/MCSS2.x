 ...
 * @author Jeff Gilfelt
 */
public class UiBadgeView extends TextView {
	...
	public UiBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public UiBadgeView(Context context, View target) {
     ...
     */
	public UiBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public UiBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public UiBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
