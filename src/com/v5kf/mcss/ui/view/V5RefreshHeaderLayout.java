 ...
 */
public class V5RefreshHeaderLayout extends LoadingLayoutBase {
    ...
    public V5RefreshHeaderLayout(Context context) {
        this(context, PullToRefreshBase.Mode.PULL_FROM_START);
    }

    public V5RefreshHeaderLayout(Context context, PullToRefreshBase.Mode mode) {
        super(context);
