...
public class BadgeView extends TextView {
	...
	private static final int BADGE_COLOR = 0xffff3a20;
    ...
    public void setBadgeLayoutParams(LayoutParams layoutParams) {
    	setLayoutParams(layoutParams);
    }
    ...
    public void setTargetView(View target) {
        ...
        if (target.getParent() instanceof FrameLayout) {
        	...
        	if (target.getParent() instanceof LinearLayout) {
        		parentContainer = (LinearLayout) target.getParent();
        		parentLayoutParams = (LinearLayout.LayoutParams) target.getLayoutParams();
//        		((LinearLayout.LayoutParams)parentLayoutParams).setMargins(
//        				-dip2Px(H_OVERFLOW), 
//        				-dip2Px(V_OVERFLOW), 
//        				-dip2Px(H_OVERFLOW), 
//        				-dip2Px(V_OVERFLOW));
...
//        				dip2Px(H_OVERFLOW), 
//        				dip2Px(V_OVERFLOW));
        	} else if (target.getParent() instanceof RelativeLayout) {
        		parentContainer = (RelativeLayout) target.getParent();
        		parentLayoutParams = (RelativeLayout.LayoutParams) target.getLayoutParams();
//        		((RelativeLayout.LayoutParams)parentLayoutParams).setMargins(
//        				-dip2Px(H_OVERFLOW), 
//        				-dip2Px(V_OVERFLOW), 
//        				-dip2Px(H_OVERFLOW), 
//        				-dip2Px(V_OVERFLOW));
...
//        				dip2Px(V_OVERFLOW));
        		...
        		parentLayoutParams = target.getLayoutParams();
        	}
