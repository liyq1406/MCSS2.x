...
public class TabThirdFragment extends TabBaseFragment {
	...
	public TabThirdFragment(MainTabActivity tabMainActivity, int index) {
	...
	protected void onCreateViewLazy(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fragment_tabmain_3);
...
//		int color = UITools.getColor(android.R.color.holo_green_dark);
