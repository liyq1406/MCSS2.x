 ...
 *
 */
public class ServingSessionFragment extends BaseFragment implements OnRefreshListener {
     ...
     * number.
     */
    public static ServingSessionFragment newInstance(BaseFragment f) {
    	ServingSessionFragment fragment = new ServingSessionFragment(f);
        return fragment;
    }
    
    public ServingSessionFragment() {
    	mRecycleBeans = new ArrayList<>();
	}

    public ServingSessionFragment(BaseFragment f) {
    	mRecycleBeans = new ArrayList<>();
    	mFragment = f;
	}
    ...
    private void initView() {
    	...
    	if (null == mRecycleAdapter) {
    		mRecycleAdapter = new ServingSessionAdapter(mRecycleBeans, mActivity);
    	}
...
//    	Logger.d(TAG, "[addRecycleBean] setPic:" + cstm.getDefaultPhoto());
//    	
...
//				Logger.i(TAG, "recycleBean.setInTrust:" + session.isInTrust());
//			}
//		}
//
...
////    	if (recycleBean.isInTrust()) {
////    		recycleBean.setTitle(getString(R.string.is_in_trust) + cstm.getDefaultName());
////    	} else {
...
//			String s_id = data.getStringExtra(Config.EXTRA_KEY_S_ID);
	...
	public void onFragmentSelected() {
		...
		Logger.d(TAG, "onFragmentSelected - ServingSession");
	}
