...
public class CaldroidFragment extends DialogFragment {
    ...
    public static int disabledTextColor = 0xFFBABABA;//Color.GRAY;
    ...
    public void setDisableDateTimes(ArrayList<DateTime> disableDateTimeList) {
        if (disableDateTimeList == null || disableDateTimeList.size() == 0) {
            return;
        }

        disableDates.clear();

        for (DateTime dateTime : disableDateTimeList) {
            disableDates.add(dateTime);
        }
    }
     ...
     * To display the week day title
     *
     * @return "SUN, MON, TUE, WED, THU, FRI, SAT" in Chinese is "日，一，二，三，四，五，六"
     */
    protected ArrayList<String> getDaysOfWeekDay() {
    	ArrayList<String> list = new ArrayList<String>();
